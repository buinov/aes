...
const uint8_t aes_invsbox[aes_invsbox_size] = {
...
const uint8_t aes_rcon[aes_rcon_size] = {0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x40, 0x80, 0x1B, 0x36};

const uint32_t aes_ssm_table[aes_byte_value_num] = {
...
const uint32_t aes_inv_ssm_table[aes_byte_value_num] = {
...
const uint8_t aes_mulx2[aes_mul_size] = {
...
const uint8_t aes_mulx3[aes_mul_size] = {
...
const uint8_t aes_mulx9[aes_mul_size] = {
...
const uint8_t aes_mulxb[aes_mul_size] = {
...
const uint8_t aes_mulxd[aes_mul_size] = {
...
const uint8_t aes_mulxe[aes_mul_size] = {
